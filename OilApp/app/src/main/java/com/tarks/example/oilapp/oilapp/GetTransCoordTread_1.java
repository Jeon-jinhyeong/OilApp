 ...
 * @author Ans
 */
class GetTransCoordThread_1 extends Thread {	// 스레드
    ...
    public GetTransCoordThread_1(boolean receiver, String x, String y, String from, String to){
    ...
    /*private void showtext(){
        ...
        handler.post(new Runnable() {	//기본 핸들러니깐 handler.post하면됨
            ...
            public void run() {
                ...
                OilApp.TransCoordThreadResponse_1(getX, getY);
